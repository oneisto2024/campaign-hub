...
const ALL_PROJECTS_COLUMNS: ColumnDef[] = [
  ...
  { key: 'projectName', label: 'Project Name', visible: true, minWidth: 140, width: 220 },
  { key: 'uniqueId', label: 'Unique ID', visible: true, minWidth: 100, width: 140 },
  { key: 'projectSummary', label: 'Project Summary', visible: true, minWidth: 120, width: 220 },
  { key: 'milestones', label: 'Milestones', visible: true, minWidth: 80, width: 100 },
  { key: 'startDate', label: 'Start Date', visible: true, minWidth: 100, width: 120 },
  { key: 'projectAllocation', label: 'Project Allocation', visible: true, minWidth: 100, width: 150 },
  ...
  { key: 'deliveryFormat', label: 'Delivery Format', visible: true, minWidth: 100, width: 130 },
  ...
  { key: 'publishStatus', label: 'Publish', visible: true, minWidth: 80, width: 100 },
  { key: 'actions', label: 'Actions', visible: true, minWidth: 80, width: 80 },
];
